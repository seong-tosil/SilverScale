    ...
    <div>
        ...
        >
            <v-row>
                <v-list-item class="d-flex" style="background-color: white;">
                    <h1 class="align-self-center ml-3">날씨</h1>
                    <div class="secondary-text-color" style="margin-left:30px;">낚시지역의 날씨 정보를 확인하는 도메인</div>
                </v-list-item>
            </v-row>
        </v-card>
        <v-col style="margin-bottom:40px;">
            <div class="text-center">
                ...
                >
                    <WeatherInfoWeather :offline="offline"  :isNew="true" :editMode="true" v-model="newValue" 
        ...
        <v-row class="ma-0 pa-0">
            <v-col class="pa-4" cols="12" sm="6" md="3" v-for="(value, index) in values" :key="index">
                <WeatherInfoWeather :offline="offline"
...
<script>
    ...
    import WeatherInfoWeather from './../WeatherInfoWeather.vue';
    ...
    export default {
        ...
        async created() {
            ...
            me.values = temp.data._embedded.weathers;
