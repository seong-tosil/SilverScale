            ...
            <v-navigation-drawer app clipped flat v-model="sideBar">
                <v-list>
                    ...
                    <v-list-item
                        class="px-2"
                        key="transfers"
                        to="/transferReservations/transfers"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
...
export default {
    ...
    data: () => ({
        ...
        aggregate: [
            { 
                title: '양도양수', 
                description: 'Transfer을 관리하는 화면입니다.', 
                key: 'transfers', 
                route: '/transferReservations/transfers',
                ImageUrl: '',
            },
            { 
                title: '날씨', 
                description: 'Weather을 관리하는 화면입니다.', 
                key: 'weathers', 
                route: '/weatherInfos/weathers',
                ImageUrl: '',
            },
